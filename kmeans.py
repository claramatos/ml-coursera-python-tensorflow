...
def find_closest_centroids(X, centroids):
    ...
    for i in range(X.shape[0]):
        J = tf.reduce_sum(tf.square(X[i] - centroids), axis=1)
        idx[i] = tf.argmin(J)
    # =============================================================
    return idx
...
def compute_centroids(X, idx, K):
    ...
    # ====================== YOUR CODE HERE ======================
    for i in range(K):
        centroids[i] = tf.reduce_mean(X[idx == i], axis=0)
    # =============================================================
    return centroids
...
def pca(X):
    ...
    # ====================== YOUR CODE HERE ======================
    sigma = (1 / m) * tf.tensordot(X.T, X, axes=1)
...
def project_data(X, U, K):
    ...
    # ====================== YOUR CODE HERE ======================
    Z = tf.tensordot(X, U[:, :K], axes=1).numpy()
    # =============================================================
    return Z
...
def recover_data(Z, U, K):
    ...
    # ====================== YOUR CODE HERE ======================
    X_rec = np.tensordot(Z, U[:, :K].T, axes=1)
    # =============================================================
    return X_rec
